<template>
  <div class="container">
    ...
    <div class="row show flezxi" v-if="!show">
      ...
      <p>
        In Fixed Interest Rate method, interest is calculated every month on the
        original loan amount. <br />
        EMI payment every month contains interest payable for the original loan
        amount for the month plus principal repayment. <br />
        On every EMI payment, outstanding loan amount reduces by the amount of
        principal repayment. <br />
        Thus interest for next month is calculated on the original loan amount.
      </p>
    </div>
